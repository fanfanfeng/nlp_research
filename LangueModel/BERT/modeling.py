# create by fanfan on 2019/1/2 0002
...
def dropout(input_tensor,droput_prob):
    """Perform dropout.
      ...
      """
    if droput_prob is None or droput_prob == 0.0:
        return input_tensor

    output = tf.nn.dropout(input_tensor,1.0 - droput_prob)
    return output
