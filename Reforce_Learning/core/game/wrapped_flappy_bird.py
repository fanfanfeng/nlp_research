...
import random
import pygame
from  Reforce_Learning.core.game import flappy_bird_utils
...
class GameState:
    ...
    def frame_step(self, input_actions):
        ...
        SCREEN.blit(IMAGES['player'][self.playerIndex], (self.playerx,
                                                         self.playery))
...
def checkCrash(player, upperPipes, lowerPipes):
    ...
    if player['y'] + player['h'] >= BASEY - 1:
        ...
        for uPipe, lPipe in zip(upperPipes, lowerPipes):
            ...
            uPipeRect = pygame.Rect(uPipe['x'], uPipe['y'], PIPE_WIDTH,
                                    PIPE_HEIGHT)
            lPipeRect = pygame.Rect(lPipe['x'], lPipe['y'], PIPE_WIDTH,
                                    PIPE_HEIGHT)
