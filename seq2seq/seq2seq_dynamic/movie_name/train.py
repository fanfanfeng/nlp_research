...
def train():
    tran_batch_manager = data_utils.BatchManager("data/train.txt.id60000.in", config.batch_size)
    test_batch_manager = data_utils.BatchManager("data/test.txt.id60000.in", config.batch_size)
