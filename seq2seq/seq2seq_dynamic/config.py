...
# 训练数据相关参数
source_vocabulary = 'data/vocab{}.in'.format(vocabulary_size) # source 的词库存储路径
target_vocabulary = 'data/vocab{}.in'.format(vocabulary_size) # target的词库存储路径,用于训练对话，所以词库是同一个
