...
if 'linux' not in sys.platform:
    data_dir = r'E:\tv_category\seq2seq'


# 训练数据相关参数
source_vocabulary = 'words_index.txt' # source 的词库存储路径
target_vocabulary = 'words_index.txt' # target的词库存储路径,用于训练对话，所以词库是同一个
...
num_encoder_symbols = 20000     # source 的词库大小
num_decoder_symbols = 20000    # target 的词库大小
