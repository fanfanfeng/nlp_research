...
def get_args_parser():
    ...
    if os.name == 'nt':
        ...
        root_path = r'E:/git-project/nlp_research/BERT-BiLSTM-CRF-NER'
    else:
        bert_path = r'/data/nlp_data/bert/model_chinese'
        root_path = r'/data/python_project/nlp_research/BERT-BiLSTM-CRF-NER'
    ...
    group1.add_argument('-data_dir',type=str,default=os.path.join(root_path,'NERData'),
                        help="train,dev and test data _dir")
    ...
    group1.add_argument('-vocab_file',type=str,default=os.path.join(bert_path,'vocab.txt'),help="")
