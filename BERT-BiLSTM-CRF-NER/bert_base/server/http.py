...
class BertHttpProxy(Process):
    ...
    def create_flask_app(self):
        ...
        bc = ConcurrentBertClient(max_concurrentcy=self.args.http_max_connect,
        ...
        def encode_query():
            ...
            try:
                ...
                logger.error('error when hadling HTTP request',exc_info=True)
                raise JsonError(description=str(e),type=str(type(e).__name__))

        CORS(app,origin=self.args.core)
        FlaskJSON(app)
