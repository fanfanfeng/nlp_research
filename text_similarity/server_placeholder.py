...
from Competition.ai_challenger_2018_sentiment_analysis.settings import ParamsModel
param = ParamsModel()
def serving_input_receiver_fn():
    ...
    label_ids = tf.placeholder(dtype=tf.int32, shape=[None,param.n_class,param.n_sub_class], name='label_ids')
