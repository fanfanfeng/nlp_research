...
NUM_EXAMPLES_PER_FOR_EVAL = 10000
...
def distorted_inputs(data_dir,batch_size):
    ...
    min_fraction_of_examples_in_queuw = 0.4
    min_queue_examples = int(NUM_EXAMPLES_PER_EPOCH_TRAIN * min_fraction_of_examples_in_queuw)
