from Segment.new_word_find.ngram_utils import sentence_split_by_punc,remove_irregular_chars,get_scores
...
def chunk_generator_adapter(obj, chunk_size):
    ...
    while True:
        ...
        if isinstance(obj, _io.TextIOWrapper):     # 输入object = open(file_name, 'r', encoding='utf-8')
        ...
        if obj_adapter != None and obj_adapter != []:
            ...
            print('~~~ Time used for data processing: {} seconds'.format(sec_used))
            break
